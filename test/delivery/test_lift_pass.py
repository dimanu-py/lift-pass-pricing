...
class TestLiftPass:
    ...
    def test_night_pass_keeps_base_price_for_people_between_six_and_sixty_four(self) -> None:
        client = app.test_client()
    ...
    def test_night_pass_gets_sixty_percent_discount_for_people_older_than_sixty_four(self) -> None:
        client = app.test_client()
    ...
    def test_1jour_pass_gets_thirty_percent_discount_for_people_younger_than_fifteen(self) -> None:
        client = app.test_client()
    ...
    def test_1jour_pass_gets_twenty_five_percent_discount_for_people_older_than_sixty_four(self) -> None:
        client = app.test_client()
    ...
    def test_1jour_pass_keeps_base_price_for_people_between_fifteen_and_sixty_four(self) -> None:
        client = app.test_client()
    ...
    def test_1jour_pass_gets_thirty_five_percent_discount_on_non_festive_mondays(self) -> None:
        client = app.test_client()

        response = client.get("/prices", query_string={'type': '1jour', 'date': '2022-01-03'})
    ...
    def test_1jour_pass_keeps_base_price_on_holidays(self) -> None:
        ...
        response = client.get("/prices", query_string={'type': '1jour', 'date': '2019-02-18'})
